/**
 * @file main.cpp
 * @brief Program 11: Time_Display_DayDate - STM32F103C8T6
 * 
 * Deskripsi:
 * Tampilan waktu dan tanggal di OLED dari DS3231
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: DS3231 + SSD1306
 * - Fitur: Clock display, Day/Date formatting
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 11: Time_Display_DayDate");
