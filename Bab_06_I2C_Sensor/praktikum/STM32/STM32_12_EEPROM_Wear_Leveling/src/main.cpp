/**
 * @file main.cpp
 * @brief Program 12: EEPROM_Wear_Leveling - STM32F103C8T6
 * 
 * Deskripsi:
 * Implementasi wear leveling untuk EEPROM
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: 24LC256/24LC512
 * - Fitur: Wear leveling algorithm, Life extension
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 12: EEPROM_Wear_Leveling");
