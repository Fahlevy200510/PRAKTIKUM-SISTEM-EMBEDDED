/**
 * @file main.cpp
 * @brief Program 09: I2C_Multi_Master - STM32F103C8T6
 * 
 * Deskripsi:
 * Operasi multi-master pada I2C bus
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: Multiple STM32/devices
 * - Fitur: Multi-master arbitration, Slave mode
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 09: I2C_Multi_Master");
