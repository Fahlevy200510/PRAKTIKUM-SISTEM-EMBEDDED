/**
 * @file main.cpp
 * @brief Program 05: DS3231_Alarm - STM32F103C8T6
 * 
 * Deskripsi:
 * Pengaturan alarm pada RTC DS3231
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: DS3231 (0x68)
 * - Fitur: Alarm interrupt, Alarm configuration
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 05: DS3231_Alarm");
