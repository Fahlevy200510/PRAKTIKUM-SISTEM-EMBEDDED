/**
 * @file main.cpp
 * @brief Program 07: EEPROM_Page_Write - STM32F103C8T6
 * 
 * Deskripsi:
 * Operasi page write pada EEPROM
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: 24LC256/24LC512 (0x50-0x57)
 * - Fitur: Page write, Timing control
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 07: EEPROM_Page_Write");
