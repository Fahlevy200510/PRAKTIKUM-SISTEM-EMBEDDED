/**
 * @file main.cpp
 * @brief Program 01: I2C_Bus_Scan - STM32F103C8T6
 * 
 * Deskripsi:
 * Pemindaian I2C Bus untuk deteksi device
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: GPIO21(SDA), GPIO22(SCL)
 * - Fitur: Bus scan, Device enumeration
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 01: I2C_Bus_Scan");
