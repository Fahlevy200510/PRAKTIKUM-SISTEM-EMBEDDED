...
## Concept
Rate Monotonic Scheduling demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 20-Rate Monotonic Scheduling
pio run -t upload
