# Program 17: Multi-DMA Concurrent Transfer

## Concept
Multi-DMA Concurrent Transfer demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 17-Multi-DMA Concurrent Transfer
pio run -t upload
