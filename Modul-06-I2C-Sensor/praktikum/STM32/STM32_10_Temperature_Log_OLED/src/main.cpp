/**
 * @file main.cpp
 * @brief Program 10: Temperature_Log_OLED - STM32F103C8T6
 * 
 * Deskripsi:
 * Logging suhu BME280 ke OLED display
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: BME280 + SSD1306
 * - Fitur: Data logging, Real-time display
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 10: Temperature_Log_OLED");
