/**
 * @file main.cpp
 * @brief Program 02: BME280_Sensor_Reading - STM32F103C8T6
 * 
 * Deskripsi:
 * Pembacaan sensor temperatur, tekanan, kelembaban BME280
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: BME280 (0x76/0x77)
 * - Fitur: Barometric sensor, Altitude calculation
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 02: BME280_Sensor_Reading");
