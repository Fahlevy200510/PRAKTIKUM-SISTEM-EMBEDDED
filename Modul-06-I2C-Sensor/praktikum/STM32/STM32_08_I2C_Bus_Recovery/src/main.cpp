/**
 * @file main.cpp
 * @brief Program 08: I2C_Bus_Recovery - STM32F103C8T6
 * 
 * Deskripsi:
 * Prosedur recovery bus I2C dari deadlock
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: GPIO21(SDA), GPIO22(SCL)
 * - Fitur: Bus recovery, Clock stretching
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 08: I2C_Bus_Recovery");
