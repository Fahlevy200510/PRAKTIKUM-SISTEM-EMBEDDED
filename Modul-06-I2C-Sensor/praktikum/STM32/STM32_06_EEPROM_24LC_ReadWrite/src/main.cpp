/**
 * @file main.cpp
 * @brief Program 06: EEPROM_24LC_ReadWrite - STM32F103C8T6
 * 
 * Deskripsi:
 * Operasi baca tulis EEPROM 24LC series
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: 24LC256/24LC512 (0x50-0x57)
 * - Fitur: Sequential read/write, Address selection
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 06: EEPROM_24LC_ReadWrite");
