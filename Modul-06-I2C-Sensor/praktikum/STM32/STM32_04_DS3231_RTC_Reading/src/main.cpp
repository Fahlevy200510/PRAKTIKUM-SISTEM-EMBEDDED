/**
 * @file main.cpp
 * @brief Program 04: DS3231_RTC_Reading - STM32F103C8T6
 * 
 * Deskripsi:
 * Pembacaan waktu dan tanggal dari RTC DS3231
 * 
 * Hardware:
 * - STM32F103C8T6 Blue Pill
 * - I2C Bus: PB6(SCL), PB7(SDA)
 * - Sensor: DS3231 (0x68)
 * - Fitur: Real-time clock, Datetime handling
 * 
 * Konfigurasi I2C:
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("Program 04: DS3231_RTC_Reading");
