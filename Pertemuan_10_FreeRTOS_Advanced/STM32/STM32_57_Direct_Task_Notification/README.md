# Program 34: Direct Task Notification

## Concept
Direct Task Notification demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 34-Direct Task Notification
pio run -t upload
