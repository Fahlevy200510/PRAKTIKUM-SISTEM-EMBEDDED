# Program 18: Cache Coherency and Data Consistency

## Concept
Cache Coherency and Data Consistency demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 18-Cache Coherency and Data Consistency
pio run -t upload
