# Program 32: Counting Semaphore Events

## Concept
Counting Semaphore Events demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 32-Counting Semaphore Events
pio run -t upload
