...
## Concept
Queue Sets Implementation demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 28-Queue Sets Implementation
pio run -t upload
