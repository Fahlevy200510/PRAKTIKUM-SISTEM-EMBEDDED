# Program 15: Throughput: DMA vs Polling

## Concept
Throughput: DMA vs Polling demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 15-Throughput: DMA vs Polling
pio run -t upload
