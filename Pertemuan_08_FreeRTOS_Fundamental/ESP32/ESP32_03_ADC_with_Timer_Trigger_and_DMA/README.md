# Program 16: ADC with Timer Trigger and DMA

## Concept
ADC with Timer Trigger and DMA demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 16-ADC with Timer Trigger and DMA
pio run -t upload
