# Program 10: ADC DMA Continuous Dual-Buffer

## Concept
ADC DMA Continuous Dual-Buffer demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 10-ADC DMA Continuous Dual-Buffer
pio run -t upload
