# Program 12: DMA Ping-Pong Double Buffering

## Concept
DMA Ping-Pong Double Buffering demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 12-DMA Ping-Pong Double Buffering
pio run -t upload
