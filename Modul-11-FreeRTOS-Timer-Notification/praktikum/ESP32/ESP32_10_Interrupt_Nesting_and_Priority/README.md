# Program 43: Interrupt Nesting Priority

## Concept
Interrupt Nesting Priority demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 43-Interrupt Nesting Priority
pio run -t upload
