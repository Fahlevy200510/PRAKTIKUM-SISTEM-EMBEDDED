# Program 09: UART TX with DMA

## Concept
UART TX with DMA demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
