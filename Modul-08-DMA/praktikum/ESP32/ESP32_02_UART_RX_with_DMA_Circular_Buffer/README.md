# Program 08: UART RX with Circular DMA

## Concept
UART RX with Circular DMA demonstrates fundamental embedded systems concepts including hardware peripheral management and/or FreeRTOS real-time operating system features.
...
### STM32
```bash
cd 08-UART RX with Circular DMA
pio run -t upload
